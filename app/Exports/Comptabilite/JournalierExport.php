...
class JournalierExport implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    protected $debut;
    protected $fin;
    ...
    {
        $now = now();
        $this->debut = $now->startOfDay()->format('Y-m-d');
        $this->fin   = $now->endOfDay()->format('Y-m-d');
    }
