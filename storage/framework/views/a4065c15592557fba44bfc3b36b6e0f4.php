                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-slate-200">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($c->raison_sociale): ?>
                                            <?php echo e($c->raison_sociale); ?> <?php echo e($c->sigle ? '('.$c->sigle.')' : ''); ?>

                                        <?php else: ?>
                                            <?php echo e($c->prenom); ?> <?php echo e($c->nom); ?>

                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-slate-200"><?php echo e($c->telephone ?? '-'); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-slate-200"><?php echo e($c->email ?? '-'); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-slate-200"><?php echo e($c->code_client); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-slate-200"><?php echo e($c->type_client); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                        <button wire:click="show(<?php echo e($c->id); ?>)" class="text-blue-400 hover:text-blue-300 mx-1" title="Voir">👁️</button>
                                        <button wire:click="edit(<?php echo e($c->id); ?>)" class="text-yellow-400 hover:text-yellow-300 mx-1" title="Modifier">✏️</button>
                                        <button wire:click="delete(<?php echo e($c->id); ?>)" wire:confirm="Supprimer ce client ?" class="text-red-400 hover:text-red-300 mx-1" title="Supprimer">🗑️</button>
                                    </td>
                                </tr>
                    ...
                    <div class="fixed inset-0 bg-slate-900 bg-opacity-75 flex items-center justify-center z-50">
                        <div class="bg-slate-800 rounded-lg shadow-xl max-w-2xl w-full p-6 mx-4 border border-slate-700 max-h-[90vh] overflow-y-auto">
                            <h2 class="text-xl font-semibold text-white mb-4">
                                <?php echo e($viewMode ? 'Détails du client' : ($form['id'] ? 'Modifier le client' : 'Ajouter un client')); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewMode): ?>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                    <div><span class="text-slate-400">Code client :</span> <?php echo e($form['code_client']); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($form['type_personne'] == 'PHYSIQUE'): ?>
                                        <div><span class="text-slate-400">Nom :</span> <?php echo e($form['nom']); ?></div>
                                        <div><span class="text-slate-400">Prénom :</span> <?php echo e($form['prenom']); ?></div>
                                    <?php else: ?>
                                        <div><span class="text-slate-400">Raison sociale :</span> <?php echo e($form['raison_sociale']); ?></div>
                                        <div><span class="text-slate-400">Sigle :</span> <?php echo e($form['sigle']); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div><span class="text-slate-400">Type client :</span> <?php echo e($form['type_client']); ?></div>
                                    <div><span class="text-slate-400">Téléphone :</span> <?php echo e($form['telephone'] ?? '-'); ?></div>
                                    <div><span class="text-slate-400">WhatsApp :</span> <?php echo e($form['whatsapp'] ?? '-'); ?></div>
                                    <div><span class="text-slate-400">Email :</span> <?php echo e($form['email'] ?? '-'); ?></div>
                                    <div><span class="text-slate-400">Adresse :</span> <?php echo e($form['adresse'] ?? '-'); ?></div>
                                    <div><span class="text-slate-400">Localité :</span> <?php echo e($localites->firstWhere('id', $form['localite_id'])?->nom ?? '-'); ?></div>
                                    <div><span class="text-slate-400">Point de vente :</span> <?php echo e($pointsVente->firstWhere('id', $form['point_vente_id'])?->nom ?? '-'); ?></div>
                                    <div><span class="text-slate-400">Type d'achat :</span> <?php echo e($form['type_achat'] ?? '-'); ?></div>
                                </div>
                                ...
                                <form wire:submit.prevent="save">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['form.code_client'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div>
                                            ...
                                            <select wire:model="form.localite_id" class="mt-1 block w-full rounded-md border-slate-600 bg-slate-700 text-white shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $localites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $localite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                    <option value="<?php echo e($localite->id); ?>"><?php echo e($localite->nom); ?></option>
                                        ...
                                        <div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['form.type_client'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-red-400"><?php echo e($message); ?></span> <?php unset($message);
...
</div><?php /**PATH C:\Users\diexa\attagest\resources\views/livewire/clients/index.blade.php ENDPATH**/ ?>